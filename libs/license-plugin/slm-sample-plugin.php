...
define('YOUR_SPECIAL_SECRET_KEY', '5b6ab78be6a274.96601867'); //Rename this constant name so it is specific to your plugin or theme.
...
define('YOUR_ITEM_REFERENCE', 'EWSTHEME'); //Rename this constant name so it is specific to your plugin or theme.

add_action('admin_menu', 'slm_sample_license_menu');

function slm_sample_license_menu() {
    add_options_page('License Activation Menu', 'Active License', 'manage_options', basename(__FILE__), 'sample_license_management_page');
}
